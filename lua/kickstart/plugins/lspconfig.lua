      ...
      local servers = {
        ...
        lua_ls = {
          on_init = function(client)
            -- Disable lua_ls formatting — stylua handles it via conform.nvim
            client.server_capabilities.documentFormattingProvider = false

            -- If the workspace has its own .luarc.json/.luarc.jsonc (e.g. a
            -- non-Neovim Lua project), don't override its settings with the
            -- Neovim-runtime-aware config below.
